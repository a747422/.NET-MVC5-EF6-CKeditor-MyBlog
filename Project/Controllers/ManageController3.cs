...
{
    [Authorize]
    public class ManageController3 : Controller
    {
        private BlogContext db = new BlogContext();
        private ApplicationSignInManager _signInManager;
        private ApplicationUserManager _userManager;

        public ManageController3()
        {
        }

        public ManageController3(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
